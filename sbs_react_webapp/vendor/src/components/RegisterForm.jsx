...
const RegisterForm = ({ onClose }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.post(`${API_URL}/ma-register-user`, formData);
            ...
            if (error.response?.data?.message && typeof error.response.data.message === 'object') {
                ...
                console.error(`Error registering user: ${errorMessages}`);
            } else {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <label className="block mb-2 font-semibold text-lg">User Registration</label>
