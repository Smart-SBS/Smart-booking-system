            ...
            <div className="px-4 pt-2 pb-2 brand" id='brand' data-bs-theme="none">
                <div>
                    <div className="d-flex align-items-center pt-1 m-4">
                        ...
                        <Link to="/admin/index" className="brand-icon text-decoration-none d-flex align-items-center" title="Smart Booking System">
                            ...
                            <span className="fw-bold ps-2 fs-5 d-none d-xl-inline-flex text-gradient">SBS</span>
                        </Link>
                    </div>
                </div>
            </div>
