...
import UserActivation from '../Partials/Pages/Authentication/UserActivation/UserActivation';
        ...
        <body data-bvite="theme-AppleGreen" className="layout-border svgstroke-a layout-default auth">
            <main className="container-fluid px-0">
                ...
                <div className="px-xl-5 px-4 auth-header" data-bs-theme="none">
                    <a href="/signin" className="brand-icon text-decoration-none d-flex align-items-center" title="Smart Booking System">
                        ...
                        <span className="fw-bold ps-2 fs-5 text-gradient">SBS</span>
                    </a>
                </div>
                ...
                <footer className="px-xl-5 px-4">
                    <p className="mb-0 text-muted">© 2024 <a href="#" title="SBS">SBS</a>, All Rights Reserved.</p>
                </footer>
