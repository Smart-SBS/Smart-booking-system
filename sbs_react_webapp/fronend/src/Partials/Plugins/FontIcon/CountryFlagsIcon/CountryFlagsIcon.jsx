    ...
    <div className="px-4 py-3 page-body">
			...
			<div className="card border-0 bg-transparent">
				<div className="card-header mb-4 border-bottom px-0">
					<h5 className="card-title mb-0 text-primary">Country Flags icon</h5>
				...
				<div className="card-body p-0">
					<div className="row g-xl-5 g-4">
						<div className="col-12">
							<p className="lead">A collection of all country flags in SVG — plus the CSS for easier integration. See the <a href="https://flagicons.lipis.dev/" target="_blank">demo</a></p>
							<p className="lead">For using the flags inline with text add the classes .flag-icon and .flag-icon-xx (where xx is the ISO 3166-1-alpha-2 code of a country) to an empty <span/>. If you want to have a squared version flag then add the class flag-icon-squared as well. Example:</p>
					...
					<div className="row g-3 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 mb-0 icons-list row-deck">
						<div className="col">
				...
				<div className="card-footer px-0 mt-4">
					<div className="btn-group d-flex">
						<Link className="btn btn-lg btn-outline-secondary text-start" to="/docs/bootstrap-icon">
							<span>
							...
							<h5 className="mb-0 ps-4">Bootstrap icon</h5>
						</Link>
						<Link className="btn btn-lg btn-outline-secondary text-end" to="/docs/fontawesome-icon">
							<span>
								<span>Next</span>
							...
							<h5 className="mb-0 pe-4">Fontawesome icon</h5>
						</Link>
					</div>
				</div>
			</div>
