...
const AddArea = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const res = await axios.post(`${APP_URL}/api/add-area`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
            ...
            if (error.response?.data?.message && typeof error.response.data.message === 'object') {
                // If the message is an object, extract all error messages
                const errorMessages = Object.values(error.response.data.message).join(', ');
                toast.error(`Error adding area: ${errorMessages}`);
            } else {
                // If it's a string or any other case, use the original approach
                toast.error(`Error adding area: ${error.response?.data?.message || error.message}`);
            }
        }
    };
        ...
        <div className="px-4 py-3 page-body">
            ...
            <div className='card'>
                <div className="card-header py-3 bg-transparent border-bottom-0">
                    <h6 className="title-font mt-2 mb-0" style={{ fontSize: '1.25rem' }}><strong>Add Area</strong></h6>
                        ...
                        <div className="row">
                            ...
                            <div className="mb-3 col-md-6 col-12">
                                <div className="form-floating">
                                    ...
                                    />
                                    <label className="col-form-label">Area Name</label>
                            ...
                            <div className="col-12">
                                <button className="me-1 btn btn-primary" type="submit">Add Area</button>
